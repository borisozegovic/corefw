...
module.exports = class CfwObject
{
    ...
    __call(methodName, argumentsin)
    {
        ...
        return new Promise((resolve, reject) =>
        {
            ...
            /*
            console.log('group: '+me.aclGroupId);
            console.log('objectNameGlob: '+me.objectNameGlob);
            console.log('methodName: '+me.methodName);
            */

            if (typeof me.lib.acl[me.aclGroupId][me.objectNameGlob] != 'undefined' && typeof me.lib.acl[me.aclGroupId][me.objectNameGlob][methodName] != 'undefined')
            {
                me.functionNameGlob = methodName;
                if (me.lib.acl[me.aclGroupId][me.objectNameGlob][me.functionNameGlob]['ownerAction'] == '1') me.ownerActionGlob = true;
                if (me.lib.acl[me.aclGroupId][me.objectNameGlob][me.functionNameGlob]['companyAction'] == '1') me.companyActionGlob = true;

                if (me.lib.acl[me.aclGroupId][me.objectNameGlob][me.functionNameGlob]['instantiate'] == '0') error = true;
            }
            else if (typeof me.lib.acl[me.aclGroupId][me.objectNameGlob] != 'undefined' && typeof me.lib.acl[me.aclGroupId][me.objectNameGlob]['instantiate'] != 'undefined')
            {
                if (me.lib.acl[me.aclGroupId][me.objectNameGlob]['ownerAction'] == '1') me.ownerActionGlob = true;
                if (me.lib.acl[me.aclGroupId][me.objectNameGlob]['companyAction'] == '1') me.companyActionGlob = true;

                if (me.lib.acl[me.aclGroupId][me.objectNameGlob]['instantiate'] == '0') error = true;
            }
            else
            {
                error = true;
            ...
            {
                //me.db.query("INSERT IGNORE INTO log_objects_err (method, classname, noPriv, notExist, username, userid, `group`, dateTime) VALUES(::p0::, ::p1::, ::p2::, ::p3::, ::p4::, ::p5::, ::p6::, NOW())", {methodName, me.objectNameGlob, 0, 1, me.session.username, me.session.userId, me.session.auth));
            ...
            /*
            			try
            			{
            				...
            				var vals = '';
            				co = _cfw_lib_Registry::fetch('co');
            				new co(me.objectNameGlob, methodName, arguments, vals, true);
            				*/
            try
            {
            ...
            /*
				if(isset(val['error']) && val['error'] != true && is_{arguments))
				{
					me.cache.deleteCacheByTag(me.objectNameGlob, arguments);
					new co(me.objectNameGlob, methodName, arguments, val);
				}
				new co(me.objectNameGlob, methodName, arguments, val, false, true);
			...
			*/
            ...
            /*
            if(isset(me.config.logActionsToDB) && me.config.logActionsToDB == true && me.objectNameGlob != false && me.preventLogging == false)
            {
            	Logging::logData(me.objectNameGlob, me.methodName, arguments, val);
            }
            */
        });
    }
